...
CONTAINER=mbs-ubuntu-1204-x64-tmp
IMAGE=mbs-ubuntu-1204-x64
...
lxc launch ubuntu:12.04 ${CONTAINER}
...
lxc publish ${CONTAINER} --alias=${IMAGE} description="This image contains the build environment for the MBS system on Ubuntu 12.04 64 bit."
