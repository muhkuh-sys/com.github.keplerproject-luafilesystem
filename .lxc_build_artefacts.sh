...
# Get all artifacts.
FILELIST=`lxc exec ${CONTAINER} -- bash -c 'find "/tmp/work" -path "/tmp/work/build/com.github.keplerproject-lua*-luafilesystem/targets/jonchki/repository/com/github/keplerproject/luafilesystem/*" -type f'`
echo ${FILELIST}
