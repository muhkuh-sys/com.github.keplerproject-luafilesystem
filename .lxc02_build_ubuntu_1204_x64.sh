...
lxc exec ${CONTAINER} -- bash -c 'tar --create --file /tmp/work/build/build_ubuntu_1204_x86_64_lua5.1.tar.gz --gzip --directory /tmp/work/build/linux/lua5.1/luafilesystem/luafilesystem-1.6.3/lib .'
lxc exec ${CONTAINER} -- bash -c 'tar --create --file /tmp/work/build/build_ubuntu_1204_x86_64_lua5.2.tar.gz --gzip --directory /tmp/work/build/linux/lua5.2/luafilesystem/luafilesystem-1.6.3/lib .'
lxc exec ${CONTAINER} -- bash -c 'tar --create --file /tmp/work/build/build_ubuntu_1204_x86_64_lua5.3.tar.gz --gzip --directory /tmp/work/build/linux/lua5.3/luafilesystem/luafilesystem-1.6.3/lib .'
