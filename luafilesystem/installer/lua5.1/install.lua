...
elseif strDistId=='ubuntu' then
  ...
  elseif strDistVersion=='17.04' then
    if strCpuArch=='x86' then
      t:install('ubuntu_1704_x86/lua_plugins/lfs.so',       '${install_lua_cpath}/')
      tResult = true
    elseif strCpuArch=='x86_64' then
      t:install('ubuntu_1704_x86_64/lua_plugins/lfs.so',    '${install_lua_cpath}/')
      tResult = true
    end

  elseif strDistVersion=='17.10' then
    if strCpuArch=='x86' then
      t:install('ubuntu_1710_x86/lua_plugins/lfs.so',       '${install_lua_cpath}/')
      tResult = true
    elseif strCpuArch=='x86_64' then
      t:install('ubuntu_1710_x86_64/lua_plugins/lfs.so',    '${install_lua_cpath}/')
      tResult = true
    end
  end
end
